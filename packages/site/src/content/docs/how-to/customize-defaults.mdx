...
- `defaults.maxWordsPerResponse` — word limit per expert response
...
See the [Configuration Reference](/Council/docs/reference/configuration/) for the complete list.
...
- [Run offline with mock engine](/Council/docs/how-to/run-offline-with-mock-engine/) — use the mock engine for testing
