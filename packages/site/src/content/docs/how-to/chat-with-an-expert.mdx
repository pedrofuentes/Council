...
1:1 chat is especially powerful with [persona experts](/Council/docs/explanation/persona-experts/) trained on your documents. The expert draws on its reference material to give document-informed responses:
...
- [Chat with a panel](/Council/docs/how-to/chat-with-a-panel/) — for multi-expert group conversations
- [Ask a quick question](/Council/docs/how-to/ask-a-quick-question/) — for one-shot queries
