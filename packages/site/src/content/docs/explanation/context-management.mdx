...
- [Deliberation Model](/Council/docs/explanation/deliberation-model) — how debate modes interact with context limits
- [Memory Model](/Council/docs/explanation/memory-model) — how persistent memory across debates contributes to context
- [Moderation Strategies](/Council/docs/explanation/moderation-strategies) — how moderators inject rolling summaries into prompts
- [Document RAG](/Council/docs/explanation/document-rag) — how retrieved document snippets count against context budgets
