...
- [Anti-Sycophancy](/Council/explanation/anti-sycophancy) — how Council enforces disagreement
- [Moderation Strategies](/Council/explanation/moderation-strategies) — how turn order is decided
- [Context Management](/Council/explanation/context-management) — how long debates stay within token budgets
- [Memory Model](/Council/explanation/memory-model) — how experts remember past debates
