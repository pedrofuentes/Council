...
See [Deliberation Model](/Council/explanation/deliberation-model) for the difference between modes.

## Relation to Other Concepts

- [Deliberation Model](/Council/explanation/deliberation-model) — how freeform and structured modes differ
- [Anti-Sycophancy](/Council/explanation/anti-sycophancy) — how devil's-advocate mode amplifies disagreement
- [Context Management](/Council/explanation/context-management) — how moderators cap prompt size with rolling summaries
