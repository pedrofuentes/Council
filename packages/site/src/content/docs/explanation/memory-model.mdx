...
Treat `~/Council/` as sensitive data. See [Security and Privacy](/Council/docs/explanation/security-and-privacy) for details on secrets handling and provider data flow.

## Relation to Other Concepts

- [Persona Experts](/Council/docs/explanation/persona-experts) — how document-driven experts combine persona profiles with debate memory
- [Document RAG](/Council/docs/explanation/document-rag) — how Council retrieves relevant document snippets to augment expert prompts
- [Context Management](/Council/docs/explanation/context-management) — how Council caps prompt size when memory grows large
- [Security and Privacy](/Council/docs/explanation/security-and-privacy) — what's stored, what's sent to providers
