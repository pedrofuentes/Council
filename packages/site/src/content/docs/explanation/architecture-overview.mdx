...
See [Security and Privacy](/Council/explanation/security-and-privacy) for full details.
...
- [Deliberation Model](/Council/explanation/deliberation-model) — how `Debate` orchestrates multi-expert conversations
- [Anti-Sycophancy](/Council/explanation/anti-sycophancy) — how the quality gate enforces disagreement
- [Memory Model](/Council/explanation/memory-model) — how SQLite stores and retrieves expert memory
- [Document RAG](/Council/explanation/document-rag) — how documents flow through detection → extraction → indexing → retrieval
- [Security and Privacy](/Council/explanation/security-and-privacy) — how layered defenses protect against prompt injection
