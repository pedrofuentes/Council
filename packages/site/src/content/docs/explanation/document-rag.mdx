...
Extracted text is **untrusted** (see [Security and Privacy](/Council/explanation/security-and-privacy) for prompt injection defenses).
...
Council applies **layered defenses** (see [Security and Privacy](/Council/explanation/security-and-privacy)):
...
- [Persona Experts](/Council/explanation/persona-experts) — how documents combine with expert definitions to create grounded personas
- [Memory Model](/Council/explanation/memory-model) — persona experts get document memory + debate memory
- [Security and Privacy](/Council/explanation/security-and-privacy) — how Council defends against prompt injection in untrusted documents
- [Context Management](/Council/explanation/context-management) — how Council caps retrieved snippets to fit token budgets
