...
- [Configuration](/Council/docs/reference/configuration/) — Full config schema
- [Expert YAML Format](/Council/docs/reference/expert-yaml/) — `docsPath` field for persona experts
