...
2. **Inline definition** (object): A full expert definition embedded directly in the panel. See [Expert YAML Format](/Council/reference/expert-yaml/) for the schema.
...
- [Expert YAML Format](/Council/reference/expert-yaml/)
