...
- [Troubleshooting](/Council/reference/troubleshooting/) — Common error scenarios
- [Environment Variables](/Council/reference/environment-variables/) — Configuration options
