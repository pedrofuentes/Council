...
| Key | Type | Default | Description |
| --- | --- | --- | --- |
| `qualityGate.mode` | `off` \| `warn` \| `regenerate` | `warn` | Quality-gate behavior: off disables it, warn flags failing responses without regenerating, regenerate re-prompts them up to maxRegenerations. |
