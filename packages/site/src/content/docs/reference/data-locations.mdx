...
|-----------|----------|-------------|
| `experts/` | `*.yaml` | Expert definitions. Reusable across panels. See [Expert YAML Format](/Council/docs/reference/expert-yaml/). |
| `panels/` | `*.yaml` | Panel definitions. Override bundled templates or define custom panels. See [Panel YAML Format](/Council/docs/reference/panel-yaml/). |
...
- [Configuration](/Council/docs/reference/configuration/) — `paths.dataHome` setting
- [Environment Variables](/Council/docs/reference/environment-variables/) — `COUNCIL_HOME`, `COUNCIL_DATA_HOME`
- [Expert YAML Format](/Council/docs/reference/expert-yaml/) — `docsPath` field
