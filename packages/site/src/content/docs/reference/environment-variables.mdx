...
The complete, always-up-to-date table of every environment variable — including non-interactive and rendering toggles such as `CI`, `ACCESSIBILITY`, `VISUAL`, and `EDITOR` — is **auto-generated from the CLI source**. See the **[Config & Environment Reference](/Council/docs/reference/config-reference/)**.
:::

## Related

- [Config & Environment Reference](/Council/docs/reference/config-reference/) — Auto-generated config + env table
