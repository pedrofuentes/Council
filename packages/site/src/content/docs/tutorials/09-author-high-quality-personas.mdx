...
- Completed [Tutorial 5: Create a Custom Expert](/Council/tutorials/05-create-a-custom-expert/)
...
- **Tutorial 10**: [Design and Lint a Panel](/Council/tutorials/10-design-and-lint-a-panel/) — Compose a full panel and verify it meets the official quality bar
- **Tutorial 13**: [Model a Real Person as a Persona Expert](/Council/tutorials/13-model-a-real-person-persona/) — Train a persona on a real person's documents so it reasons like them
