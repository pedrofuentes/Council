...
- Completed [Tutorial 7: Ground a Debate in Documents](/Council/docs/tutorials/07-ground-a-debate-in-documents/)
...
- **Tutorial 12**: [Automate Council in CI or Scripts](/Council/docs/tutorials/12-automate-council-in-ci-or-scripts/) — Script Council for CI pipelines, offline environments, and reproducible decision logs
