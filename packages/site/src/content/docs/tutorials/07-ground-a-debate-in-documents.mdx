...
- Completed [Tutorial 6: Build a Custom Panel](/Council/docs/tutorials/06-build-a-custom-panel/)
...
```bash
council convene product-review "Should we prioritize the mobile app redesign in Q3, or focus on web performance?"
```
...
- [Tutorial 8: Continue, Conclude, and Export](/Council/docs/tutorials/08-continue-conclude-and-export/) — resume debates, synthesize decisions, and export artifacts
